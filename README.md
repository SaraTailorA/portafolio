...
* **CSS Box Model:** Managing margins, padding, and borders for a clean layout.
* **Navigation:** Implementing internal anchors (`#`) and page-to-page linking.
* **Responsive Basics:** Using `max-width` and flexible layouts for better display.
...
* `mascotas.html`: A secondary page displaying a gallery of my pets (Owen, Logan, and Leonardo).
* `styles.css`: A centralized stylesheet managing the visual identity (colors, fonts, and hover effects).
...
* **Interactive Elements:** CSS `:hover` effects on buttons and navigation links for better UX.
* **Modern Styling:** Implementation of `border-radius`, `box-shadow`, and custom color palettes (Vibrant Purple & Deep Blue).
